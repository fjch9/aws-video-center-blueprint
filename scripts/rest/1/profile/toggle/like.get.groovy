...
profile = ProfileUtils.toggleVideo(profileService, profile, params.id, "likedVideos")
profile = ProfileUtils.removeVideo(profileService, profile, params.id, "dislikedVideos")
