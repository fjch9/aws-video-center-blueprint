...
var renderEventItem=function(parent,video,videoBaseUrl){var url=videoBaseUrl+video.id;var className=parent.parent().parent().parent().find('.grid-system > .current').data('class')
return `  
...
liveText.addClass('hide')}else{jQuery(video_selector).append(renderEventItem(jQuery(video_selector),element,videoBaseUrl))}
