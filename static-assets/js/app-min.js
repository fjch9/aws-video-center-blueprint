...
var getGridSystemClasses=function(gridSystemItem){return'item group-item-'+gridSystemItem.attr('class')}
var renderVideoItem=function(parent,video){var url=`/live?id=${video.id}`;var classNames=getGridSystemClasses(parent.parent().parent().parent().find('.grid-system > .current'))
return `  
